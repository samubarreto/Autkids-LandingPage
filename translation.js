...
const translations = {
  'pt': {
    ...
    'btn_download': 'Receba novidades por email',
    'btn_download_short': 'Novidades por email',
    'nav_about': 'Sobre',
    'nav_pricing': 'Planos',
    'nav_download': 'Receber novidades',
    ...
    'pricing_desc': 'Nosso app está em fase final de testes para <strong>App Store</strong> e <strong>Google Play</strong>. Deixe seu email para avisarmos quando ele estiver pronto ou quando tivermos novidades.',
    'waitlist_cta_btn': 'Receber novidades por email',
    ...
    'waitlist_title': 'Receba novidades do Autkids por email',
    'waitlist_desc': 'Deixe seu nome e email. Avisaremos quando o app estiver pronto ou quando tivermos novidades.',
    'waitlist_name_placeholder': 'Seu nome',
    'waitlist_placeholder': 'seu@email.com',
    'waitlist_btn': 'Quero receber novidades',
    'waitlist_success': 'Combinado! Enviaremos um email quando o app estiver pronto ou quando tivermos novidades 💛',
    'waitlist_trust': 'Usaremos seu email para avisar quando o app estiver pronto ou quando tivermos novidades. Sem spam.',
  ...
  'en': {
    ...
    'btn_download': 'Get updates by email',
    'btn_download_short': 'Email updates',
    'nav_about': 'About',
    'nav_pricing': 'Plans',
    'nav_download': 'Get updates',
    ...
    'pricing_desc': "Our app is in final testing for the <strong>App Store</strong> and <strong>Google Play</strong>. Leave your email and we'll let you know when it's ready or whenever we have news to share.",
    'waitlist_cta_btn': 'Get updates by email',
    ...
    'waitlist_title': 'Get Autkids updates by email',
    'waitlist_desc': 'Leave your name and email. We’ll let you know when the app is ready or whenever we have news to share.',
    'waitlist_name_placeholder': 'Your name',
    'waitlist_placeholder': 'your@email.com',
    'waitlist_btn': 'Sign me up for updates',
    'waitlist_success': "Thanks! We'll email you when the app is ready or whenever we have news to share 💛",
    'waitlist_trust': 'We’ll use your email for Autkids launch and product updates. No spam.',
  ...
  'es': {
    ...
    'btn_download': 'Recibe novedades por correo',
    'btn_download_short': 'Novedades por correo',
    'nav_about': 'Acerca de',
    'nav_pricing': 'Planes',
    'nav_download': 'Recibir novedades',
    ...
    'pricing_desc': 'Nuestra app está en fase final de pruebas para la <strong>App Store</strong> y <strong>Google Play</strong>. Déjanos tu correo y te avisaremos cuando esté lista o cuando tengamos novedades.',
    'waitlist_cta_btn': 'Recibir novedades por correo',
    ...
    'waitlist_title': 'Recibe novedades de Autkids por correo',
    'waitlist_desc': 'Déjanos tu nombre y correo. Te avisaremos cuando la app esté lista o cuando tengamos novedades.',
    'waitlist_name_placeholder': 'Tu nombre',
    'waitlist_placeholder': 'tu@correo.com',
    'waitlist_btn': 'Quiero recibir novedades',
    'waitlist_success': '¡Listo! Te enviaremos un correo cuando la app esté lista o tengamos novedades 💛',
    'waitlist_trust': 'Usaremos tu correo para enviarte novedades sobre el lanzamiento y Autkids. Sin spam.',
